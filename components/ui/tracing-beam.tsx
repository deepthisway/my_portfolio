    ...
    <motion.div ref={ref} className={cn("relative mx-auto h-full w-full max-w-4xl", className)}>
      <div className="absolute top-3 -left-4 md:-left-20">
        <motion.div
          ...
          className="border-neutral-200 dark:border-neutral-700 ml-[27px] flex h-4 w-4 items-center justify-center rounded-full border shadow-sm bg-white dark:bg-gray-900"
        >
          <motion.div
            transition={{
              duration: 0.2,
            ...
            animate={{
              ...
              borderColor: scrollYProgress.get() > 0 ? "#d1d5db" : "#059669",
            }}
            className="h-2 w-2 rounded-full border border-neutral-300 dark:border-neutral-600 bg-white dark:bg-gray-800"
          />
        </motion.div>
        <svg viewBox={`0 0 20 ${svgHeight}`} width="20" height={svgHeight} className="ml-4 block" aria-hidden="true">
          ...
          <defs>
            <motion.linearGradient id="gradient" gradientUnits="userSpaceOnUse" x1="0" x2="0" y1={y1} y2={y2}>
              ...
              <stop offset="0.325" stopColor="#d1d5db" />
